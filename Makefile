...
# Caution: Only edit this if you need to modify NON-RECURSIVE-Makefile's behavior (fix
#          bugs, add features, etc.
#          Don't edit this Makefile otherwise! Create your own target.mk and other
...
$(eval $(call INCLUDE_SUBMAKEFILE,target.mk))
